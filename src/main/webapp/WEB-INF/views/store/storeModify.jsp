	...
	<div class="container">	
		<div class="register" style="width:540px;margin-left:530px;border:1px;">
		    <div class="info-container">
		        <div class="pop-conts">
		            <form id="info_form" action="/store/storeModify" method="post">
					<div class="logo_wrap2">
						<h2 style="margin-top:30px;margin-right:200px;margin-left:-260px;margin-bottom:50px;">매장 정보 수정</h2>
					</div>
					<div class="login_id2" style="margin-top: 10px;">
						<h4 style="padding-left: 72px;">매장 이름</h4>
						<div class="col">
							<input name="st_name" value="${storeInfo.st_name}">
						</div>
					</div>
					<div class="login_id2">
						<h4 style="padding-left: 72px;">사업자번호</h4>
						<div class="col">
							<input id="pw_input" name="st_biznum" value="${storeInfo.st_biznum}">
						</div>
					</div>
					<div class="login_id2">
					...
					<div class="login_id2">
						...
						<div class="col">
							<input id="tel_input" name="st_tel" value="${storeInfo.st_tel}">
						</div>
					...
					<div class="login_id2">
						...
						<div class="col">
							<input type="time" id="tel_input" name="st_time1" value="${storeInfo.st_time1}" style="width:33%;"> ~&nbsp 
							<input type="time" id="tel_input" name="st_time2" value="${storeInfo.st_time2}" style="width:33%;margin-left:-6px;">
						</div>
							<span class="final_tel_ck">전화번호를 입력해주세요.</span>
					</div>
					<div class="login_id2">
						...
						<div class="addr_input_box">
							<input id="address_input_1" name="st_addr1" value="${storeInfo.st_addr1}"
					...
					<div class="login_id2" style="margin-top: 10px;">
						<div class="col">
							<input id="address_input_2" name="st_addr2" value="${storeInfo.st_addr2}"
					...
					<div class="login_id2" style="margin-top: 10px;">
						...
						<div class="col">
							<input id="address_input_3" name="st_addr3" value="${storeInfo.st_addr3}">
						</div>
					</div>
					...
					<div class="login_id2">
						...
						<div class="col">
							<textarea id="st_info_input" name="st_info">${storeInfo.st_info}
							</textarea>
						</div>
							<span class="final_tel_ck">전화번호를 입력해주세요.</span>
					</div>
				...
				<input type="hidden" name='st_id' value="${storeInfo.st_id}">
				</form>
				<div style="transform: translate(-86%,-80%);">
				<div class="submit2" >
					...
					<input type="button" id="delete_button" value="삭제" style="transform: translate(230%,-200%);margin-left: 160px;background: tomato;">
				</div>
				</div>
...
<script>
	$(document).ready(function(){
		...
		$('#delete_button').on("click", function(e){
			e.preventDefault();
			$('#info_form').attr("action", "/store/storeDelete?st_id=${storeInfo.st_id }");
